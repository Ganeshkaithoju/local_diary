/**
 * Shared unique-key rules — server constants + validation.
 *
 ...
 * lowercase letter and one digit. Kept dependency-free so the Convex
 * functions and the UI validate identically from this single module.
 */

/** Max failed key sign-ins per identifier inside the window. */
export const MAX_ATTEMPTS = 10;
/** Rolling window for the attempt counter (10 minutes). */
